      ...
      {showPopup && (
        <div className="popup-overlay">
          <div className="popup-content">
            ...
            <p>
              If you are not able to see events or register/login, the backend
              server might be down. It is hosted on Render, and the free tier
              may have expired. It usually renews at the beginning of the month.
            ...
            {events.map((event) => (
              <div key={event._id} className="event-card">
                ...
                <div className="event-content">
                  <h2 className="event-title">Knees Ups</h2>
                  <p className="event-description">
                    Party all night with live jamming with most wanted singer
                  </p>
                  ...
                  <div className="event-details">
                    ...
                    <div className="event-detail">
                      <MapPin size={16} />
                      <span>Beltola, Guwahati</span>
                    </div>
                    <div className="event-detail">
                      <Users size={16} />
                      <span>{event.capacity} 15 seat remaining</span>
                    </div>
